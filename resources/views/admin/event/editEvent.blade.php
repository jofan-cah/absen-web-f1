...
<div class="p-4 sm:p-6 max-w-3xl mx-auto">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <p class="text-xs text-gray-500">{{ $event->event_id }} — {{ $event->title }}</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.event.update', $event->event_id) }}" class="space-y-6">
        @csrf @method('PUT')
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-300">{{ old('description', $event->description) }}</textarea>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <label for="allow_multi_scan" class="text-sm text-gray-700">Izinkan scan berulang</label>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-4">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="radius" value="{{ old('radius', $event->radius) }}" min="10"
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-300">
                </div>
            </div>
        </div>
