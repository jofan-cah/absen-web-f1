        ...
        <div class="relative overflow-hidden">
            ...
            <div class="relative flex items-center justify-between h-12 px-3 text-white">
                <div class="flex items-center space-x-2">
                    <div class="w-7 h-7 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center border border-white/20 shadow-lg">
                ...
                <button @click="sidebarOpen = false"
                    class="lg:hidden p-1 hover:bg-white/10 rounded-lg transition-all">
        ...
        <nav class="flex-1 px-2.5 py-2.5 overflow-y-auto sidebar-scroll">
            ...
            <div class="mb-1.5">
                <a href="{{ route('admin.dashboard') }}"
                    ...
                    <div class="flex items-center justify-center w-7 h-7 mr-2 rounded-lg nav-icon bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-md">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mb-1.5">
                <a href="{{ route('admin.karyawan.index') }}"
                    ...
                    @click="window.innerWidth < 1024 && (sidebarOpen = false)">
                    <div class="flex items-center justify-center w-7 h-7 mr-2 rounded-lg nav-icon bg-gradient-to-br from-green-500 to-emerald-600 text-white shadow-md">
            ...
            <div class="mb-1.5">
                ...
                <div class="space-y-1">
                    <a href="{{ route('admin.department.index') }}"
                        ...
                        @click="window.innerWidth < 1024 && (sidebarOpen = false)">
                        <div class="flex items-center justify-center w-6 h-6 mr-2 rounded-md nav-icon bg-gradient-to-br from-violet-400 to-purple-500 text-white shadow-sm">
                    ...
                    <a href="{{ route('admin.shift.index') }}"
                        ...
                        @click="window.innerWidth < 1024 && (sidebarOpen = false)">
                        <div class="flex items-center justify-center w-6 h-6 mr-2 rounded-md nav-icon bg-gradient-to-br from-orange-400 to-red-500 text-white shadow-sm">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.user.index') }}"
                        ...
                        @click="window.innerWidth < 1024 && (sidebarOpen = false)">
                        <div class="flex items-center justify-center w-6 h-6 mr-2 rounded-md nav-icon bg-gradient-to-br from-indigo-400 to-blue-500 text-white shadow-sm">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span class="text-xs bg-indigo-100 text-indigo-700 font-bold px-1.5 py-0.5 rounded-full">{{ App\Models\User::count() }}</span>
                    </a>
                </div>
            </div>
            @endif
            ...
            <div class="mb-1.5">
                <div class="flex items-center px-2.5 py-1.5 mb-1">
                    <div class="w-1.5 h-1.5 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full mr-2 animate-pulse"></div>
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.jadwal.index') }}"
                        ...
                        @click="window.innerWidth < 1024 && (sidebarOpen = false)">
                        <div class="flex items-center justify-center w-6 h-6 mr-2 rounded-md nav-icon bg-gradient-to-br from-blue-400 to-cyan-500 text-white shadow-sm">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.jadwal.calendar') }}"
                        ...
                        @click="window.innerWidth < 1024 && (sidebarOpen = false)">
                        <div class="flex items-center justify-center w-6 h-6 mr-2 rounded-md nav-icon bg-gradient-to-br from-indigo-400 to-purple-500 text-white shadow-sm">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                        ...
                        @if($isCoordinator)
                        <span class="text-xs bg-green-100 text-green-700 font-bold px-1.5 py-0.5 rounded-full">Dept</span>
                        @endif
                    </a>
                </div>
            </div>
            ...
            <div class="mb-1.5">
                <div class="flex items-center px-2.5 py-1.5 mb-1">
                    <div class="w-1.5 h-1.5 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full mr-2 animate-pulse"></div>
                ...
                <div class="space-y-1">
                    <a href="{{ route('admin.absen.index') }}"
                        ...
                        @click="window.innerWidth < 1024 && (sidebarOpen = false)">
                        <div class="flex items-center justify-center w-6 h-6 mr-2 rounded-md nav-icon bg-gradient-to-br from-green-400 to-emerald-500 text-white shadow-sm">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.absen.report') }}"
                        ...
                        @click="window.innerWidth < 1024 && (sidebarOpen = false)">
                        <div class="flex items-center justify-center w-6 h-6 mr-2 rounded-md nav-icon bg-gradient-to-br from-cyan-400 to-blue-500 text-white shadow-sm">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mb-4">
                <div class="flex items-center px-2.5 py-1.5 mb-1">
                    <div class="w-1.5 h-1.5 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full mr-2"></div>
                ...
                <div class="space-y-1">
                    <a href="{{ route('admin.tunjangan-type.index') }}"
                        ...
                        @click="window.innerWidth < 1024 && (sidebarOpen = false)">
                        <div class="flex items-center justify-center w-6 h-6 mr-2 rounded-md nav-icon bg-gradient-to-br from-yellow-400 to-orange-500 text-white shadow-sm">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span class="text-xs bg-yellow-100 text-yellow-700 font-bold px-1.5 py-0.5 rounded-full">{{ \App\Models\TunjanganType::count() }}</span>
                    </a>
                    ...
                    <a href="{{ route('admin.tunjangan-detail.index') }}"
                        ...
                        @click="window.innerWidth < 1024 && (sidebarOpen = false)">
                        <div class="flex items-center justify-center w-6 h-6 mr-2 rounded-md nav-icon bg-gradient-to-br from-emerald-400 to-green-500 text-white shadow-sm">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.penalti.index') }}"
                        ...
                        @click="window.innerWidth < 1024 && (sidebarOpen = false)">
                        <div class="flex items-center justify-center w-6 h-6 mr-2 rounded-md nav-icon bg-gradient-to-br from-red-400 to-pink-500 text-white shadow-sm">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span class="text-xs bg-red-100 text-red-700 font-bold px-1.5 py-0.5 rounded-full">{{ $activePenalties }}</span>
                        @endif
                    </a>
...
<svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-2.5 bg-gradient-to-r from-gray-50/50 to-slate-100/50 backdrop-blur-sm border-t border-gray-200/50">
