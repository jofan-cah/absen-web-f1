...
<div class="flex flex-wrap gap-3">
    ...
    <button onclick="requestTunjangan()" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2">
    ...
    <button onclick="approveTunjangan()" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors flex items-center gap-2">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <button onclick="confirmReceived()" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors flex items-center gap-2">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Other Actions -->
    <button onclick="printDetail()" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors flex items-center gap-2">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <button onclick="deleteTunjangan()" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors flex items-center gap-2">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <h4 class="text-xl font-bold text-gray-900">{{ $tunjanganKaryawan->karyawan->full_name }}</h4>
                                <div class="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                                    <div>
                                        <span class="text-gray-500">NIP:</span>
                                        <span class="font-medium text-gray-900 ml-2">{{ $tunjanganKaryawan->karyawan->nip }}</span>
                                    </div>
                                    <div>
                                        <span class="text-gray-500">Departemen:</span>
                                        <span class="font-medium text-gray-900 ml-2">{{ $tunjanganKaryawan->karyawan->department->name ?? '-' }}</span>
                                    </div>
                                    <div>
                                        <span class="text-gray-500">Posisi:</span>
                                        <span class="font-medium text-gray-900 ml-2">{{ $tunjanganKaryawan->karyawan->position }}</span>
                                    </div>
                                    <div>
                                        <span class="text-gray-500">Status Staff:</span>
                                        <span class="font-medium text-gray-900 ml-2">{{ ucfirst(str_replace('_', ' ', $tunjanganKaryawan->karyawan->staff_status)) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 space-y-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="font-medium text-gray-900">{{ $tunjanganKaryawan->tunjanganType->name }}</div>
                                    <div class="text-sm text-gray-500">{{ $tunjanganKaryawan->tunjanganType->code }} • {{ ucfirst($tunjanganKaryawan->tunjanganType->category) }}</div>
                                </div>
                            </div>
                            <div class="text-right">
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg p-4">
                            ...
                            <div class="space-y-2 text-sm">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium text-gray-900">Rp {{ number_format($tunjanganKaryawan->amount, 0, ',', '.') }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Hari kerja asli:</span>
                                    <span class="font-medium text-gray-900">{{ $tunjanganKaryawan->hari_kerja_asli ?? $tunjanganKaryawan->quantity }} hari</span>
                                </div>
                                @if($tunjanganKaryawan->hari_potong_penalti > 0)
                                <div class="flex justify-between">
                                    <span class="text-red-600">Hari potong penalti:</span>
                                    <span class="font-medium text-red-600">-{{ $tunjanganKaryawan->hari_potong_penalti }} hari</span>
                                </div>
                                @endif
                                <div class="border-t border-gray-200 pt-2 flex justify-between">
                                    <span class="text-gray-600 font-medium">Hari kerja final:</span>
                                    <span class="font-bold text-green-600">{{ $tunjanganKaryawan->hari_kerja_final ?? ($tunjanganKaryawan->hari_kerja_asli ?? $tunjanganKaryawan->quantity) }} hari</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 space-y-4">
                        <div class="bg-white rounded-lg p-3 border border-gray-200">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-medium text-gray-900">{{ $tunjanganKaryawan->period_start->format('d M Y') }}</span>
                            </div>
                            <div class="flex items-center justify-between mt-1">
                                <span class="text-sm text-gray-600">Berakhir:</span>
                                <span class="font-medium text-gray-900">{{ $tunjanganKaryawan->period_end->format('d M Y') }}</span>
                            </div>
                            <div class="border-t border-gray-200 pt-2 mt-2">
                                <div class="flex items-center justify-between">
                                    <span class="text-sm font-medium text-gray-600">Durasi:</span>
                                    <span class="font-bold text-purple-600">
                                        {{ $tunjanganKaryawan->period_start->diffInDays($tunjanganKaryawan->period_end) + 1 }} hari
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                            <div>
                                ...
                                <span class="text-indigo-900 ml-2">{{ $tunjanganKaryawan->absen->absen_id }}</span>
                            </div>
                            <div>
                                <span class="text-indigo-600 font-medium">Tanggal:</span>
                                <span class="text-indigo-900 ml-2">{{ $tunjanganKaryawan->absen->date->format('d M Y') }}</span>
                            </div>
                            <div>
                                <span class="text-indigo-600 font-medium">Jam Kerja:</span>
                                <span class="text-indigo-900 ml-2">{{ $tunjanganKaryawan->absen->work_hours ?? 0 }} jam</span>
                            </div>
                            @if($tunjanganKaryawan->quantity > 1)
                            <div>
                                <span class="text-indigo-600 font-medium">Jam Lembur:</span>
                                <span class="text-indigo-900 ml-2">{{ $tunjanganKaryawan->quantity }} jam</span>
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                        <div class="grid grid-cols-1 gap-3 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="text-red-900">{{ $tunjanganKaryawan->penalti->penalti_id }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-red-600 font-medium">Jenis:</span>
                                <span class="text-red-900">{{ ucfirst(str_replace('_', ' ', $tunjanganKaryawan->penalti->jenis_penalti)) }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-red-600 font-medium">Hari Potong:</span>
                                <span class="text-red-900 font-bold">{{ $tunjanganKaryawan->penalti->hari_potong_uang_makan }} hari</span>
                            </div>
                            <div class="pt-2 border-t border-red-200">
                                <span class="text-red-600 font-medium">Deskripsi:</span>
                                <p class="text-red-900 text-xs mt-1">{{ $tunjanganKaryawan->penalti->deskripsi }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                        <div class="grid grid-cols-1 gap-3 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-gray-900">{{ $tunjanganKaryawan->created_at->format('d M Y H:i') }}</span>
                            </div>

                            @if($tunjanganKaryawan->requested_at)
                            <div class="flex justify-between">
                                <span class="text-gray-600">Di-request:</span>
                                <span class="font-medium text-gray-900">{{ $tunjanganKaryawan->requested_at->format('d M Y H:i') }}</span>
                            </div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-gray-900">{{ $tunjanganKaryawan->approved_at->format('d M Y H:i') }}</span>
                            </div>
                            @if($tunjanganKaryawan->approvedBy)
                            <div class="flex justify-between">
                                <span class="text-gray-600">Disetujui oleh:</span>
                                <span class="font-medium text-gray-900">{{ $tunjanganKaryawan->approvedBy->name }}</span>
                            </div>
                            @endif
                            @endif
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-gray-900">{{ $tunjanganKaryawan->received_at->format('d M Y H:i') }}</span>
                            </div>
                            @endif
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                        <img src="{{ Storage::url($tunjanganKaryawan->received_confirmation_photo) }}"
            ...
            @else
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600">{{ $tunjanganKaryawan->created_at->format('d M Y H:i') }}</p>
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600">{{ $tunjanganKaryawan->requested_at->format('d M Y H:i') }}</p>
                        <p class="text-sm text-gray-500">Request via {{ ucfirst($tunjanganKaryawan->requested_via) }}</p>
                    </div>
                </div>
                @endif
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600">{{ $tunjanganKaryawan->approved_at->format('d M Y H:i') }}</p>
                        <p class="text-sm text-gray-500">Oleh: {{ $tunjanganKaryawan->approvedBy->name ?? 'Admin' }}</p>
                    </div>
                </div>
                @endif
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600">{{ $tunjanganKaryawan->received_at->format('d M Y H:i') }}</p>
