    ...
    <div class="lg:col-span-2 space-y-6">
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-base font-semibold text-gray-900">{{ $lembur->tanggal_lembur->format('d F Y') }}</p>
                ...
                <div class="border-t pt-4">
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-primary-600">{{ number_format($lembur->total_jam, 1) }} jam</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">
                @if($lembur->approved_at) Informasi Persetujuan @else Informasi Penolakan @endif
            </h3>

            <div class="space-y-3">
                <div>
                    <p class="text-sm text-gray-500">
                        @if($lembur->approved_at) Disetujui Oleh @else Ditolak Oleh @endif
                    </p>
                    <p class="text-base font-medium text-gray-900">
                ...
                <div>
                    ...
                    <p class="text-base text-gray-900 bg-green-50 p-3 rounded-lg">{{ $lembur->approval_notes }}</p>
                </div>
                @endif
                @if($lembur->rejection_reason)
                <div>
                    <p class="text-sm text-gray-500">Alasan Penolakan</p>
                    <p class="text-base text-gray-900 bg-red-50 p-3 rounded-lg">{{ $lembur->rejection_reason }}</p>
                </div>
                @endif
            </div>
        </div>
            ...
            <div class="space-y-3">
                <div class="flex items-center justify-between p-4 bg-indigo-50 rounded-lg">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-indigo-600">Rp {{ number_format($lembur->tunjanganKaryawan->total_amount, 0, ',', '.') }}</p>
                    </div>
