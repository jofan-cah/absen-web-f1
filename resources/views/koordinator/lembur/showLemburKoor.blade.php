    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <div class="flex items-center gap-3 flex-wrap">
                            ...
                            @if ($lembur->koordinator_status == 'pending')
                                <span
                                    class="px-3 py-1 inline-flex items-center gap-1.5 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-700 animate-pulse">
                            ...
                            @elseif($lembur->koordinator_status == 'approved')
                                <span
                                    class="px-3 py-1 inline-flex items-center gap-1.5 text-xs font-semibold rounded-full bg-green-100 text-green-700">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M5 13l4 4L19 7" />
                                    </svg>
                            ...
                            @elseif($lembur->koordinator_status == 'rejected')
                                <span
                                    class="px-3 py-1 inline-flex items-center gap-1.5 text-xs font-semibold rounded-full bg-red-100 text-red-700">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-base font-medium text-gray-900">
                            {{ optional($lembur->created_at)->format('d/m/Y H:i') }}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-sm text-blue-600 font-medium">{{ $quantity }}x Insentif Kehadiran</p>
                                    <p class="text-xs text-blue-500">Rp {{ number_format($amountPerUnit, 0, ',', '.') }} ×
                                        {{ $quantity }}</p>
                                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        <div
                            ...
                            <div class="text-right">
                                <span
                                    class="px-3 py-1 text-xs font-semibold rounded-full {{ $lembur->tunjanganKaryawan->status == 'pending' ? 'bg-yellow-100 text-yellow-700' : ($lembur->tunjanganKaryawan->status == 'approved' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700') }}">
                        ...
                        <div class="text-sm text-gray-500 space-y-1">
                            <p>Quantity: <span
                                    class="font-medium text-gray-900">{{ $lembur->tunjanganKaryawan->quantity }}x</span>
                            </p>
                            <p>Amount per unit: <span class="font-medium text-gray-900">Rp
                                    {{ number_format($lembur->tunjanganKaryawan->amount, 0, ',', '.') }}</span></p>
                        </div>
                    </div>
                </div>
            @endif
        ...
        <div class="space-y-6">
            ...
            @elseif($lembur->koordinator_status == 'approved')
                ...
                <div
                    class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl shadow-sm border border-green-200 p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-green-700 mt-1">Anda sudah approve lembur ini pada
                                    {{ $lembur->koordinator_approved_at->format('d/m/Y H:i') }}</p>
                            </div>
                        </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-red-700 mt-1">Anda sudah reject lembur ini pada
                                    {{ $lembur->koordinator_rejected_at->format('d/m/Y H:i') }}</p>
                            </div>
                        </div>
                        @if ($lembur->koordinator_notes)
