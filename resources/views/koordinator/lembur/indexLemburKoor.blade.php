...
<div class="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
    ...
    <button onclick="resetFilter()" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors">
        Reset Filter
    </button>
</div>
@endsection
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="text-sm font-semibold text-gray-900">{{ number_format($lembur->total_jam, 1) }} jam</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        @php
                            $statusConfig = [
                                ...
                                'processed' => ['bg' => 'bg-blue-100', 'text' => 'text-blue-700', 'label' => 'Diproses'],
                            ];
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-500">Data lembur dari karyawan department Anda akan muncul di sini</p>
                        </div>
                    </td>
                </tr>
                @endforelse
