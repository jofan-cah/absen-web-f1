    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::middleware(['role:admin'])->group(function () {
            ...
            Route::prefix('tunjangan-karyawan')->name('tunjangan-karyawan.')->group(function () {
                ...
                Route::post('/{tunjanganKaryawan}/reset-to-x1', [TunjanganKaryawanController::class, 'resetToX1'])->name('reset-to-x1')->withoutMiddleware(['role:admin'])->middleware(['role:admin,coordinator']);
